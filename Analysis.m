...
switch SessionData.SettingsFile.GUIMeta.RiskType.String{SessionData.SettingsFile.GUI.RiskType}
    ...
    case 'Cued' % currently only designed for 1-arm
        ...
        SampleTimeBoxChartHandle = boxchart(SampleTimeHandle, TrialDataTable.TrialRewardProb, TrialDataTable.SampleTime);
        ...
        SampleTimeStats = grpstats(TrialDataTable(~isnan(TrialDataTable.EarlyWithdrawal), :),...
        ...
        MoveTimeBoxChartHandle = boxchart(MoveTimeHandle, TrialDataTable.TrialRewardProb, TrialDataTable.MoveTime);
        ...
        MoveTimeStats = grpstats(TrialDataTable(~isnan(TrialDataTable.ChoiceLeft), :),...
                                 'TrialRewardProb', {'mean', 'std'},...
                                 'DataVars', 'MoveTime',...
                                 'VarNames', {'Pr', 'Count', 'Mean', 'Std'});
